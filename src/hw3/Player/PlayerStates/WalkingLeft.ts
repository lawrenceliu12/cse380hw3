...
export default class WalkingLeft extends PlayerState {

	onEnter(options: Record<string, any>): void {
		this.parent.speed = this.parent.MIN_SPEED;
        this.owner.animation.playIfNotAlready(PlayerAnimations.WALKING_LEFT);
	}
	...
	update(deltaT: number): void {
		...
		if(dir.isZero()){
            ...
            this.finished(PlayerStates.ATTACKING_LEFT);
        }
